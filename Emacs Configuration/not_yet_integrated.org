...
*** Load Monokai theme as standard theme
    ...
    #+BEGIN_SRC emacs-lisp
      (load-theme 'monokai t) ;; load the black monokai theme        (load-theme 'monokai t) ;; load the black monokai theme  
    #+END_SRC
...
** Shortcuts to insert chunk of code
   ...
   Notice the keyboard shortcut to insert org babel code chuncks was
   replaced by snippets. I note here however the structure to define
   keyboard shortcuts in local mode
